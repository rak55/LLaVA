...
def eval_model(args):
    ...
    for idx in tqdm(range(len(dataset))):
        ...
        #print(demo_img_list)
        demo_img_list.extend(img_list)       #you can try just sending the query image. it means demos has been just useful for rationale gen. and answer depends on rationale.
        #print(img_list)
        ...
        pred = run(full_conv, demo_img_list)
